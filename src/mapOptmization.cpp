...
public:
    ...
    void laserCloudInfoHandler(const lio_sam::msg::CloudInfo::SharedPtr msgIn)
    {
        ...
        if (timeLaserInfoCur - timeLastProcessing >= mappingProcessInterval)
        {
            ...
            updateInitialGuess();
                        // RCLCPP_INFO(get_logger(), "finish a updateInitialGuess...\n");


            extractSurroundingKeyFrames();
                        // RCLCPP_INFO(get_logger(), "finish a extractSurroundingKeyFrames...\n");


            downsampleCurrentScan();
                        // RCLCPP_INFO(get_logger(), "finish a downsampleCurrentScan...\n");


            scan2MapOptimization();
                        // RCLCPP_INFO(get_logger(), "finish a scan2MapOptimization...\n");


            saveKeyFramesAndFactor();
                        // RCLCPP_INFO(get_logger(), "finish a saveKeyFramesAndFactor...\n");


            correctPoses();
                        // RCLCPP_INFO(get_logger(), "finish a correctPoses...\n");


            publishOdometry();
                        // RCLCPP_INFO(get_logger(), "finish a publishOdometry...\n");


            publishFrames();
                        // RCLCPP_INFO(get_logger(), "finish a publishFrames...\n");
    ...
    void updateInitialGuess()
    {
        ...
        {
            // RCLCPP_INFO(get_logger(), "cloudInfo.imu_available: true\n");
        ...
        // RCLCPP_INFO(get_logger(), "cloudInfo.imu_available: false\n");
    }
