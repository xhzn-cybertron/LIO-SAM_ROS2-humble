# LIO-SAM Supported Humble
适用于linder叉车平台的LIO-SAM（IMU:100HZ LIDAR:20Hz 其他参数见Config） 外参 TF还没有加
主要issue是imu积分轨迹一直往下走 LIDAR的optimization把轨迹拉回来 就出现了上下的跳变，可能提高IMU的频率可以稍微解决？好像给gtsam加鲁棒核也可以实现平滑？
有后端，全局一致性十分好：
<p align='center'>
    <img src="./config/doc/liosam1.png" alt="drawing" width="800"/>
</p>
<p align='center'>
    <img src="./config/doc/liosam2.png" alt="drawing" width="800"/>
</p>    
<p align='center'>
    <img src="./config/doc/liosam3.png" alt="drawing" width="800"/>
</p>    
<p align='center'>
    <img src="./config/doc/liosam4.png" alt="drawing" width="800"/>
</p>       
